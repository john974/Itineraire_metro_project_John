...
public class CreationReseau0 {
     ...
     */
    public static Reseau initialiserReseau (Reseau reseau) {
        ...
        /********************************/
        /* Creation des lignes de metro */
        /********************************/
        /* Ligne 1 */
            Ligne ligne1 = new Ligne(1, "Ligne 1", 24); //Creation de la ligne
            LinkedList<Station> listStations1 = new LinkedList<Station>(); //Creation de la liste de stations a ajouter a la ligne
            ...
            listStations1.add(gareDeLyon);
            listStations1.add(bastille);
            listStations1.add(stPaul);
            listStations1.add(hotelDeVille);
            listStations1.add(chatelet);
            listStations1.add(louvreRivoli);
            listStations1.add(palaisRoyalMuseeDuLouvre);
            listStations1.add(tuileries);
            listStations1.add(concorde);
            listStations1.add(champsElyseesClemenceau);
            listStations1.add(franklinDRoosevelt);
            listStations1.add(georgeV);
            listStations1.add(charlesDeGaulleEtoile);
            listStations1.add(argentine);
            listStations1.add(porteMaillot);
            listStations1.add(lesSablons);
            listStations1.add(pontDeNeuilly);
            listStations1.add(esplanadeDeLaDefense);
            listStations1.add(laDefense);

            ligne1.setListStations(listStations1);

        /* Ligne 4 */
            Ligne ligne4 = new Ligne(4, "Ligne 4", 26); //Creation de la ligne
            LinkedList<Station> listStations4 = new LinkedList<Station>(); //Creation de la liste de stations a ajouter a la ligne

            listStations4.add(porteDeClignancourt);
            listStations4.add(simplon);
            listStations4.add(marcadetPoissonniers);
            listStations4.add(chateauRouge);
            listStations4.add(barbesRochechouart);
            listStations4.add(gareDuNord);
            listStations4.add(gareDeLEst);
            listStations4.add(chateauDEau);
            listStations4.add(strasbourgSaintDenis);
            listStations4.add(reaumurSebastopol);
            listStations4.add(etienneMarcel);
            listStations4.add(lesHalles);
            listStations4.add(chatelet);
            listStations4.add(cite);
            listStations4.add(stMichel);
            listStations4.add(odeon);
            listStations4.add(saintGermainDesPres);
            listStations4.add(saintSulpice);
            listStations4.add(stPlacide);
            listStations4.add(montparnasseBienvenue);
            listStations4.add(valvin);
            listStations4.add(raspail);
            listStations4.add(moutonDuvernet);
            listStations4.add(alesia);
            listStations4.add(porteDOrleans);

            ligne4.setListStations(listStations4);

        /* Ligne 8 */
            Ligne ligne8 = new Ligne(8, "Ligne 8", 40); //Creation de la ligne
            LinkedList<Station> listStations8 = new LinkedList<Station>(); //Creation de la liste de stations a ajouter a la ligne

            listStations8.add(balard);
            listStations8.add(lourmel);
            listStations8.add(boucicaut);
            listStations8.add(felixFaure);
            listStations8.add(commerce);
            listStations8.add(cambronne);
            listStations8.add(laMottePicquetGrenelle);
            listStations8.add(ecoleMilitaire);
            listStations8.add(laTourMaubourg);
            listStations8.add(invalides);
            listStations8.add(concorde);
            listStations8.add(madeleine);
            listStations8.add(opera);
            listStations8.add(richelieuDrouot);
            listStations8.add(grandsBoulevards);
            listStations8.add(bonneNouvelle);
            listStations8.add(strasbourgSaintDenis);
            listStations8.add(republique);
            listStations8.add(fillesDuCalvaire);
            listStations8.add(saintSebastienFroissart);
            listStations8.add(cheminVert);
            listStations8.add(bastille);
            listStations8.add(ledruRollin);
            listStations8.add(faidherbeChaligny);
            listStations8.add(reuillyDiderot);
            listStations8.add(montgallet);
            listStations8.add(daumesnil);
            listStations8.add(michelBizot);
            listStations8.add(porteDoree);
            listStations8.add(porteDeCharenton);
            listStations8.add(liberte);
            listStations8.add(charentonEcoles);
            listStations8.add(ecoleVeterinaireDeMaisonsAlfort);
            listStations8.add(maisonsAlfortStade);
            listStations8.add(maisonsAlfortLesJuilliotes);
            listStations8.add(creteilLEchat);
            listStations8.add(creteilUniversite);
            listStations8.add(creteilPrefecture);
            listStations8.add(creteilPointeDuLac);

            ligne8.setListStations(listStations8);
            
        /* Ligne 12 */
            Ligne ligne12 = new Ligne(12, "Ligne 12", 30); //Creation de la ligne
            LinkedList<Station> listStations12 = new LinkedList<Station>(); //Creation de la liste de stations a ajouter a la ligne

            listStations12.add(porteDeLaChapelle);
            listStations12.add(marxDormoy);
            listStations12.add(marcadetPoissonniers);
            listStations12.add(julesJoffrin);
            listStations12.add(lamarckCaulaincourt);
            listStations12.add(abbesses);
            listStations12.add(pigalle);
            listStations12.add(saintGeorges);
            listStations12.add(notreDameDeLorette);
            listStations12.add(triniteDEstienneDOrves);
            listStations12.add(saintLazare);
            listStations12.add(madeleine);
            listStations12.add(concorde);
            listStations12.add(assembleeNationale);
            listStations12.add(solferino);
            listStations12.add(rueDuBac);
            listStations12.add(sevresBabylone);
            listStations12.add(rennes);
            listStations12.add(notreDameDesChamps);
            listStations12.add(montparnasseBienvenue);
            listStations12.add(falguiere);
            listStations12.add(pasteur);
            listStations12.add(volontaires);
            listStations12.add(vaugirard);
            listStations12.add(convention);
            listStations12.add(porteDeVersailles);
            listStations12.add(corentinCelton);
            listStations12.add(mairieDIssy);

            ligne12.setListStations(listStations12);
            
        /* Ligne 14 */
            Ligne ligne14 = new Ligne(14, "Ligne 14", 10); //Creation de la ligne
            LinkedList<Station> listStations14 = new LinkedList<Station>(); //Creation de la liste de stations a ajouter a la ligne

            listStations14.add(saintLazare);
            listStations14.add(madeleine);
            listStations14.add(pyramides);
            listStations14.add(chatelet);
            listStations14.add(gareDeLyon);
            listStations14.add(bercy);
            listStations14.add(courStEmilion);
            listStations14.add(bibliothequeFrMitterrand);
            listStations14.add(olympiades);

            ligne14.setListStations(listStations14);


        /**********************/
        /* Creation du reseau */
        /**********************/
        reseau = new Reseau(null);
